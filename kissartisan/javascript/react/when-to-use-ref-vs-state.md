...
This is useful for more than just DOM nodes. Basically you use the ref hook. Anytime you want to maintain a reference to something and you want to be able to make changes to that thing without triggering a rerender.
